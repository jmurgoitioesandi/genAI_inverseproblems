...
class NCSNv2(nn.Module):
    def __init__(self, config):
        ...
        self.begin_conv = nn.Conv2d(
            config.data.channels + config.data.meas_channels,
            ngf,
            3,
            stride=1,
            padding=1,
        ...
        self.res1 = nn.ModuleList(
            [
                ResidualBlock(
                    self.ngf, self.ngf, resample=None, act=act, normalization=self.norm
                ),
                ResidualBlock(
                    self.ngf, self.ngf, resample=None, act=act, normalization=self.norm
                ),
    ...
    def forward(self, x, y, s):
        ...
        used_sigmas = self.sigmas[s].view(x.shape[0], *([1] * len(x.shape[1:])))
...
"""
NCSNv2Deeper and Deepest have not been tested in the current project. 
"""
