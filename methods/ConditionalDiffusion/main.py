...
def parse_args_and_config():
    ...
    parser.add_argument("--seed", type=int, default=123457, help="Random seed")
    parser.add_argument(
        "--exp", type=str, default="exps", help="Path for saving running related data."
    )
    parser.add_argument(
        "--doc",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="images",
        help="The folder/file name of samples",
    )
    parser.add_argument(
        "--ni",
        action="store_true",
    ...
    if args.problem == "HelmholtzEq":
        new_config.data.meas_channels = 2
        new_config.data.size = 4
    elif args.problem == "HeatEqSingleSource":
