...
class lamina_cribrosa:
    def __init__(self, param_list):
        self.LC_x_1 = param_list[0]
        self.LC_y_1 = param_list[1]
        self.LC_x_2 = param_list[2]
        self.LC_y_2 = self.LC_y_1 + param_list[3]
        self.LC_x_3 = self.LC_x_2 + param_list[4]
        self.LC_y_3 = param_list[5]
        self.LC_x_4 = self.LC_x_1 + param_list[6]
        self.LC_y_4 = param_list[7]
        self.radius_12 = param_list[8]
        self.radius_34 = self.radius_12 + param_list[9]
...
class sclera_taper_left:
    def __init__(self, LC_y_1, LC_y_4, LC_x_1, LC_x_4, param_list):
        dist1 = param_list[0]
        dist2 = param_list[1]
        ...
        self.SCTL_x_4 = self.SCTL_x_3 - param_list[2]
        self.SCTL_y_4 = self.SCTL_y_3 + param_list[3]
        self.distance_41 = param_list[4]
...
class sclera_left:
    def __init__(self, SCT_x_1, SCT_y_1, SCT_x_4, SCT_y_4, param_list):
        self.SCL_x_2 = SCT_x_1
        self.SCL_y_2 = SCT_y_1
        self.SCL_x_3 = SCT_x_4
        self.SCL_y_3 = SCT_y_4
        self.radius_34 = param_list[0]
        self.radius_12 = self.radius_34 + param_list[1]
        ...
        while (
            ...
            self.radius_34 = abs(self.SCL_x_4 - self.center_x_34) + 0.05
            self.radius_12 = abs(self.SCL_x_1 - self.center_x_12) + 0.05
...
class sclera_taper_right:
    def __init__(self, LC_y_2, LC_y_3, LC_x_2, LC_x_3):
        ...
        self.SCTR_x_3 = self.SCTR_x_4 + 0.6
        self.SCTR_y_3 = self.SCTR_y_4 + 0.1
        self.distance_32 = 0.8
...
class sclera_right:
    def __init__(self, SCTR_x_2, SCTR_y_2, SCTR_x_3, SCTR_y_3):
        ...
        self.radius_34 = 12
        self.radius_12 = self.radius_34 + 1
...
class upper_ONH:
    def __init__(self, ULC_x_4, ULC_y_4, ULC_x_3, ULC_y_3, function1_par, param_list):
        ...
        self.UONH_y_4 = ULC_y_4 + param_list[0]
        self.UONH_x_3 = ULC_x_3
        self.UONH_y_3 = ULC_y_3 + param_list[1]
        self.function1_type = "line"
        self.function2_type = "vertical"
...
class optic_nerve:
    def __init__(self, LLC_x_1, LLC_y_1, LLC_x_2, LLC_y_2, function3_par, param_list):
        self.ON_x_4 = LLC_x_1
        self.ON_y_4 = LLC_y_1
        self.ON_x_3 = LLC_x_2
        self.ON_y_3 = LLC_y_2
        ...
        self.ON_y_1 = -1.5
        self.ON_y_2 = -1.5
        self.ON_x_1 = LLC_x_1 - param_list[0]
        self.ON_x_2 = LLC_x_2 + param_list[1]
        self.radius_23 = param_list[2]
        self.radius_41 = param_list[3]
        self.function1_type = "line"
...
class pia_matter_left:
    def __init__(self, ON_x_1, ON_y_1, ON_x_4, ON_y_4, function2_par, param_list):
        self.PML_x_2 = ON_x_1
        self.PML_y_2 = ON_y_1
        self.PML_x_3 = ON_x_4
        self.PML_y_3 = ON_y_4
        self.function2_par1 = function2_par
        self.width1 = param_list[0]
        self.width2 = param_list[1]
...
def generate_mu_domain_withparams(x_0, y_0, scale, param_list, H, W):
    LC = lamina_cribrosa(param_list[:10])
    ...
    LC_SM = param_list[26]  # Zhang 2020
    SCL_SM = param_list[
        27
    ...
    UONH_SM = param_list[28]  # Sahan 2018
    RL_SM = param_list[29]
    # RR_SM = random_modulus_gen(9800, 3340)
    ON_SM = param_list[30]
    PML_SM = param_list[31]
    # PMR_SM = random_modulus_gen(125000, 50000)
    rotation_angle = param_list[32]
